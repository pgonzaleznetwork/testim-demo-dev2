        ...
        if(!component.get("v.objLabel")){
            ...
            action.setCallback(this,function(response){
                ...
                if(state === "SUCCESS"){
                    ...
                    console.log("An error occurred while getting the object label: "+JSON.stringify(response.error));
                }else{
                    console.log("Unknown error. State: "+state+", error: "+JSON.stringify(response.error));
                }
            });
